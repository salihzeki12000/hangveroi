								...
								<div class="col-md-12 tabs-area">
									<ul id="tabs-product" class="nav nav-tabs nav-tabs-v3" role="tablist">
										<li role="presentation" class="active">
											<a href="#tabs-info" id="tabs-product-1" role="tab" data-toggle="tab" aria-expanded="true">Video Information</a>
										</li>
									</ul>
									<div id="tabsDemo4Content" class="tab-content tab-content-v3">
										<div role="tabpanel" class="tab-pane fade active in" id="tabs-info" aria-labelledby="tabs-info">
											<div class="col-md-12">
												...
												<div class="form-group form-animate-text" style="margin:40px 0 !important;">
													<input type="url" class="form-text" id="txt_link" value="{{ $link }}" name="link" required>
													<span class="bar"></span>
													<label>Link</label>
												</div>
											</div>
...
<script>
	$(document).ready(function(){
		...
		$("#signupForm").validate({
			...
			messages: {
				txt_name: "Please enter name of product type",
			}
		});
	});
</script>
