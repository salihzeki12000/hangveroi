								...
								<div class="col-md-12 tabs-area">
									<ul id="tabs-product" class="nav nav-tabs nav-tabs-v3" role="tablist">
										<li role="presentation" class="active">
											<a href="#tabs-info" id="tabs-product-1" role="tab" data-toggle="tab" aria-expanded="true">{{ trans('news.news_info') }}</a>
										</li>
										<li role="presentation" class="">
											<a href="#tabs-image" role="tab" id="tabs-product-2" data-toggle="tab" aria-expanded="false">{{ trans('news.image_lib') }}</a>
										</li>
									</ul>
										...
										<div role="tabpanel" class="tab-pane fade active in" id="tabs-info" aria-labelledby="tabs-info">
											<div class="col-md-12">
												<div class="form-group form-animate-text" style="margin:40px 0 !important;">
													...
													<span class="bar"></span>
													<label>{{ trans("news.name") }}</label>
												</div>
												<div class="form-group" style="margin-bottom:40px !important;">
													<label style="font-size: 18px; padding: 5px;">{{ trans("news.content") }}</label>
												...
												<div class="panel-body">
													<div class="gc_photo" id="gc_photo">
														<table cellspacing="0" cellpadding="0">
															@if(isset($newsImageItems))
															@foreach($newsImageItems as $img)
															<tr id="row_{{ $img->id }}">
													...
													<script type="text/javascript">
														...
														$(function() {
															$('#file_upload').uploadify({
																...
																'uploader' : '{{ URL::to(Request::segment(1)."/news/image/upload") }}',
																'queueSizeLimit': 10,
													...
													<script type="text/javascript">
														function add_product_image(data, index)
														{
															...
															$.ajax({
																url: _base_url + "admin/news/image/get",
																data: {
																	'id': '{{ Request::segment(4) }}',
																	'_token': '{{ csrf_token() }}',
																},
														...
														function remove_product_image(id)
														{
															...
															{
																$.ajax({
																	url: _base_url + "admin/news/image/delete",
																	data: {
																		'id': id,
																		'_token': '{{ csrf_token() }}',
																	},
								...
								<div class="row">
									<div class="col-md-12 padding-0">
										<div class="box-type col-sm-12 padding-0">
											@include('admin.block.news.list_category')
										</div>
